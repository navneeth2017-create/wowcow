...
async function seed() {
  ...
  try {
    ...
    // ── Products ──────────────────────────────────────────────────────────────
    const products = [
      { name:'WowCow Whole Milk 1 Gallon',          description:'Fresh whole milk, locally sourced.',       sku:'WC-MILK-01',  stock:500, image_url:'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400', prices:{ store_owner:3.20, distributor:2.80, rep:2.95, master_distributor:2.50 } },
      { name:'WowCow 2% Reduced Fat Milk 1 Gallon', description:'Reduced fat milk with great taste.',       sku:'WC-MILK-02',  stock:400, image_url:'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=400', prices:{ store_owner:3.10, distributor:2.70, rep:2.85, master_distributor:2.40 } },
      { name:'WowCow Heavy Cream 1 Pint',           description:'Rich heavy cream for cooking and baking.', sku:'WC-CREAM-01', stock:250, image_url:'https://images.unsplash.com/photo-1587657566382-7c9b1a1c9459?w=400', prices:{ store_owner:4.50, distributor:3.90, rep:4.10, master_distributor:3.50 } },
      { name:'WowCow Butter Unsalted 1 lb',         description:'Premium unsalted butter.',                 sku:'WC-BUTR-01',  stock:350, image_url:'https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=400', prices:{ store_owner:5.20, distributor:4.50, rep:4.80, master_distributor:4.00 } },
      { name:'WowCow Cheddar Cheese Block 2 lb',    description:'Sharp cheddar cheese block.',              sku:'WC-CHDR-01',  stock:200, image_url:'https://images.unsplash.com/photo-1618164436241-4473940d1f5c?w=400', prices:{ store_owner:9.80, distributor:8.50, rep:9.00, master_distributor:7.80 } },
      { name:'WowCow Greek Yogurt 32 oz',           description:'Thick and creamy Greek yogurt.',           sku:'WC-YGRT-01',  stock:300, image_url:'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', prices:{ store_owner:4.20, distributor:3.60, rep:3.90, master_distributor:3.20 } },
    ];
